        ...
        <div className="main">
            <div className="container">
                ...
                <div className="col-lg-8">
                    {/* Trending Tittle */}
                    <div className="about-right mb-5">
                    <div className="about-img">
                        <img
                        src="https://themewagon.github.io/aznews/assets/img/trending/trending_top.jpg"
                        alt=""
                        />
                    </div>
                    <div className="section-tittle mb-3 pt-3">
                    ...
                    <div className="about-prea">
                        ...
                        compliment is being told that I look like my mom. Seeing myself in
                        her image, like this daughter up top, makes me so proud of how far
                        I’ve come, and so thankful for where I come from. the refractor
                        ...
                        Collimation is a term for how well tuned the telescope is to give
                        you a good clear image of what you are looking at. You want your
                        telescope to have good collimation so you are not getting a false
                        image of the celestial body. Aperture is a fancy word for how big
                        the lens of your telescope is. But it’s an important word because
                        the aperture of the lens is the key to how powerful your telescope
                        ...
                        tripod your telescope sits on. The mount is the actual tripod and
                        the wedge is the device that lets you attach the telescope to the
                        mount. Moms are like…buttons? Moms are like glue. Moms are like
                        pizza crusts. Moms are the ones who make sure things happen—from
                    ...
                    <div className="about-prea">
                        ...
                        the eyepiece. The reflector telescope has a concave lens which
                        means it bends in. It uses mirrors to focus the image that you
                        eventually see.
                        </p>
                        <p className="about-pera1 mb-25">
                        Collimation is a term for how well tuned the telescope is to give
                        ...
                        The reflector telescope has a concave lens which means it bends
                        in. It uses mirrors to focus the image that you eventually see.
                        Collimation is a term fo Moms are like…buttons? Moms are like
                        glue. Moms are like pizza crusts. Moms are the ones who make sure
                        things happen—from birth to school lunch.
                        </p>
                        <p className="about-pera1 mb-25">
                        Mount and Wedge. Both of these terms refer to the tripod your
                        telescope sits on. The mount is the actual tripod and the wedge is
                        the device that lets you attach the telescope to the mount. Moms
                        are like…buttons? Moms are like glue. Moms are like pizza crusts.
                        Moms are the ones who make sure things happen—from birth to school
                        lunch.
                        </p>
                        <p className="about-pera1 mb-25">
                        Mount and Wedge. Both of these terms refer to the tripod your
                    ...
                    <div className="social-share pt-3">
                        <div className="section-tittle">
                        <h3 className="mr-2">Share:</h3>
                        <ul>
                            <li>
                            <a href="#">
                                <img
